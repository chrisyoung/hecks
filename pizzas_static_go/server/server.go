...
func (app *App) Start(port int) error {
	...
	mux.HandleFunc("GET /pizzas", func(w http.ResponseWriter, r *http.Request) {
		...
		renderer.Render(w, "index", "Pizzas", PizzaIndexData{AggregateName: "Pizza", Description: "A pizza with a name, description, and toppings. Demonstrates value objects, lists, validations, and queries.", CsrfToken: csrfToken(w, r), Items: rows, Columns: []PizzaColumn{{Label: "Name"}, {Label: "Description"}, {Label: "Toppings"}}, Buttons: []PizzaButton{{Label: "Create Pizza", Href: "/pizzas/create_pizza/new", Allowed: true}}, RowActions: []RowAction{{Label: "Add Topping", HrefPrefix: "/pizzas/add_topping/new?id=", Allowed: true}}})
	})
	...
	mux.HandleFunc("GET /orders", func(w http.ResponseWriter, r *http.Request) {
		...
		renderer.Render(w, "index", "Orders", OrderIndexData{AggregateName: "Order", Description: "A customer order referencing a pizza. Demonstrates references, transitions, and collection proxies.", CsrfToken: csrfToken(w, r), Items: rows, Columns: []OrderColumn{{Label: "Customer Name"}, {Label: "Items"}, {Label: "Status"}}, Buttons: []OrderButton{{Label: "Place Order", Href: "/orders/place_order/new", Allowed: true}}, RowActions: []RowAction{{Label: "Cancel Order", HrefPrefix: "/orders/cancel_order", Allowed: true, Direct: true, IdField: "order"}}})
	})
