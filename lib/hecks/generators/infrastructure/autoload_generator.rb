  ...
  module Generators
    ...
    class AutoloadGenerator
      ...
      def generate_entry_point
        ...
        lines << "# Add connection gems to your Gemfile to auto-wire:"
        ...
        lines << "# Remove a gem to unwire that connection. No code changes needed."
        ...
        lines << "    Hecks.connection_registry.each { |_name, hook| hook.call(self, domain, @runtime) }"
        lines << "    @runtime"
        lines << "  end"
        lines << ""
