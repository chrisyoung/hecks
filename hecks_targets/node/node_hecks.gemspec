...
Gem::Specification.new do |spec|
  spec.name          = "node_hecks"
  spec.version       = Hecks::VERSION
  spec.authors       = ["Christopher Young"]
  spec.license       = "MIT"
  spec.homepage      = "https://github.com/chrisyoung/hecks"
  spec.summary       = "Node.js/TypeScript domain generator for Hecks"
  spec.description   = "Generates self-contained Node.js/TypeScript projects from Hecks domain definitions"
