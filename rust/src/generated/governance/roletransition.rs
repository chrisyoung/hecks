// GENERATED by bin/project_rust from examples/compliance (uses_framework "Governance")'s canonical IR.
...
pub fn dispatch_grant(
    repo: &mut impl crate::kernel::Repository<RoleTransition>, id: &str, args: GrantArgs, mutations: &mut Vec<crate::kernel::MutationRecord>, owner_deref: Vec<(&'static str, crate::kernel::DerefNode)>, command_deref: Vec<(&'static str, crate::kernel::DerefNode)>,
