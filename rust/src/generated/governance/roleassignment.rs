...
pub fn dispatch_assign(
    repo: &mut impl crate::kernel::Repository<RoleAssignment>, id: &str, args: AssignArgs, mutations: &mut Vec<crate::kernel::MutationRecord>, owner_deref: Vec<(&'static str, crate::kernel::DerefNode)>, command_deref: Vec<(&'static str, crate::kernel::DerefNode)>,
