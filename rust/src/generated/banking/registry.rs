...
pub const PROCESS_MANAGERS: &[crate::kernel::ProcessManagerDef] = &[
    crate::kernel::ProcessManagerDef { name: "Onboarding", correlates_by: "reference.value", starts_on: "OnboardingOpened", ends_on: "AccountOpened", initial_state: "screening", handlers: &[crate::kernel::Handler { event_type: "OnboardingCleared", from_state: "screening", to_state: "cleared", dispatches: &[crate::kernel::DispatchSpec { command_name: "Account.Open", with: &[("customer", crate::kernel::WithValue::Ref("customer")), ("number", crate::kernel::WithValue::Ref("account_number")), ("kind", crate::kernel::WithValue::Literal(pm_literal_0)), ("daily_limit", crate::kernel::WithValue::Literal(pm_literal_1))], reverses: None }] }, crate::kernel::Handler { event_type: "OnboardingDeclined", from_state: "screening", to_state: "declined", dispatches: &[] }] },
    crate::kernel::ProcessManagerDef { name: "Settlement", correlates_by: "reference.value", starts_on: "TransferRequested", ends_on: "TransferSettled", initial_state: "requested", handlers: &[crate::kernel::Handler { event_type: "TransferRequested", from_state: "requested", to_state: "requested", dispatches: &[crate::kernel::DispatchSpec { command_name: "Account.Debit", with: &[("number", crate::kernel::WithValue::Ref("source")), ("amount", crate::kernel::WithValue::Ref("amount")), ("narrative", crate::kernel::WithValue::Literal(pm_literal_2)), ("reference", crate::kernel::WithValue::Ref("reference"))], reverses: Some(&crate::kernel::DispatchSpec { command_name: "Account.Credit", with: &[("number", crate::kernel::WithValue::Ref("source")), ("amount", crate::kernel::WithValue::Ref("amount")), ("narrative", crate::kernel::WithValue::Literal(pm_literal_4))], reverses: None }) }] }, crate::kernel::Handler { event_type: "AccountDebited", from_state: "requested", to_state: "awaiting_credit", dispatches: &[crate::kernel::DispatchSpec { command_name: "Transfer.Debited", with: &[("transfer", crate::kernel::WithValue::Ref("reference"))], reverses: None }, crate::kernel::DispatchSpec { command_name: "Account.Credit", with: &[("number", crate::kernel::WithValue::Ref("destination")), ("amount", crate::kernel::WithValue::Ref("amount")), ("narrative", crate::kernel::WithValue::Literal(pm_literal_3)), ("reference", crate::kernel::WithValue::Ref("reference"))], reverses: None }] }, crate::kernel::Handler { event_type: "AccountCredited", from_state: "awaiting_credit", to_state: "awaiting_credit", dispatches: &[crate::kernel::DispatchSpec { command_name: "Transfer.Credited", with: &[("transfer", crate::kernel::WithValue::Ref("reference"))], reverses: None }] }, crate::kernel::Handler { event_type: "TransferCredited", from_state: "awaiting_credit", to_state: "settled", dispatches: &[crate::kernel::DispatchSpec { command_name: "Transfer.Settle", with: &[("transfer", crate::kernel::WithValue::Ref("reference"))], reverses: None }] }, crate::kernel::Handler { event_type: "refused", from_state: "awaiting_credit", to_state: "reversed", dispatches: &[crate::kernel::DispatchSpec { command_name: "Transfer.Reverse", with: &[("transfer", crate::kernel::WithValue::Ref("reference"))], reverses: None }] }] },
    crate::kernel::ProcessManagerDef { name: "ExternalSettlement", correlates_by: "end_to_end.value", starts_on: "ExternalTransferRequested", ends_on: "ExternalTransferSent", initial_state: "requested", handlers: &[crate::kernel::Handler { event_type: "ExternalTransferRequested", from_state: "requested", to_state: "requested", dispatches: &[crate::kernel::DispatchSpec { command_name: "ExternalTransfer.SendTransfer", with: &[("end_to_end", crate::kernel::WithValue::Ref("end_to_end"))], reverses: None }] }, crate::kernel::Handler { event_type: "refused", from_state: "requested", to_state: "returned", dispatches: &[crate::kernel::DispatchSpec { command_name: "ExternalTransfer.Return", with: &[("end_to_end", crate::kernel::WithValue::Ref("end_to_end"))], reverses: None }] }] },
];
