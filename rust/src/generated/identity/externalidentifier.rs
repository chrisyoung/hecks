    ...
    pub fn check_invariants(&self) -> Result<(), crate::kernel::Refusal> {
{
    ...
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("value"))))))), &ctx)?.truthy() {
        return Err(crate::kernel::Refusal::InvariantViolation("ExternalIdentifierKey violates its invariant: a key is present".to_string()));
    }
}
        Ok(())
    }
    ...
    pub fn check_invariants(&self) -> Result<(), crate::kernel::Refusal> {
{
    let ctx = crate::kernel::EvalContext { args: &crate::kernel::NoFields, instance: self };
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("value"))))))), &ctx)?.truthy() {
        return Err(crate::kernel::Refusal::InvariantViolation("Issuer violates its invariant: an issuer is present".to_string()));
    }
}
        Ok(())
    }
    ...
    pub fn check_invariants(&self) -> Result<(), crate::kernel::Refusal> {
{
    let ctx = crate::kernel::EvalContext { args: &crate::kernel::NoFields, instance: self };
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("value"))))))), &ctx)?.truthy() {
        return Err(crate::kernel::Refusal::InvariantViolation("Subject violates its invariant: a subject is present".to_string()));
    }
}
        Ok(())
    }
...
pub fn dispatch_link(
    repo: &mut impl crate::kernel::Repository<ExternalIdentifier>, args: LinkArgs,
