    ...
    pub fn check_invariants(&self) -> Result<(), crate::kernel::Refusal> {
{
    ...
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("value"))))))), &ctx)?.truthy() {
        ...
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.value) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "AggregateName.value must match [^ \\t\\n\\r], got ", self.value))); }
        Ok(())
    }
}
    ...
    pub fn check_invariants(&self) -> Result<(), crate::kernel::Refusal> {
{
    ...
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("value"))))))), &ctx)?.truthy() {
        ...
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.value) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "Description.value must match [^ \\t\\n\\r], got ", self.value))); }
        Ok(())
    }
}
    ...
    pub fn check_invariants(&self) -> Result<(), crate::kernel::Refusal> {
{
    ...
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("value"))))))), &ctx)?.truthy() {
        ...
        return Err(crate::kernel::Refusal::InvariantViolation(crate::kernel::RefusalSite::InvariantViolationValueObjectInvariant.render(&[
            ("name", "IdentityField"),
            ("description", "an identity field is present"),
            ("offered", offered.as_str()),
        ])));
    }
}
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.value) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "IdentityField.value must match [^ \\t\\n\\r], got ", self.value))); }
        Ok(())
    }
}
    ...
    pub fn check_invariants(&self) -> Result<(), crate::kernel::Refusal> {
{
    ...
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("value"))))))), &ctx)?.truthy() {
        ...
        return Err(crate::kernel::Refusal::InvariantViolation(crate::kernel::RefusalSite::InvariantViolationValueObjectInvariant.render(&[
            ("name", "IdentityPath"),
            ("description", "an identity path is present"),
            ("offered", offered.as_str()),
        ])));
    }
}
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.value) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "IdentityPath.value must match [^ \\t\\n\\r], got ", self.value))); }
        Ok(())
    }
}
...
}
{
    ...
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("list"))))))), &ctx)?.truthy() {
        ...
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.name) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "Field.name must match [^ \\t\\n\\r], got ", self.name))); }
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.r#type) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "Field.type must match [^ \\t\\n\\r], got ", self.r#type))); }
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.list) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "Field.list must match [^ \\t\\n\\r], got ", self.list))); }
        Ok(())
    }
}
    ...
    pub fn check_invariants(&self) -> Result<(), crate::kernel::Refusal> {
{
    ...
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("name"))))))), &ctx)?.truthy() {
        ...
        return Err(crate::kernel::Refusal::InvariantViolation(crate::kernel::RefusalSite::InvariantViolationValueObjectInvariant.render(&[
            ("name", "ValueName"),
            ("description", "a value object name is present"),
            ("offered", offered.as_str()),
        ])));
    }
}
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.name) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "ValueName.name must match [^ \\t\\n\\r], got ", self.name))); }
        Ok(())
    }
}
...
{
    let ctx = crate::kernel::EvalContext { args: &crate::kernel::NoFields, instance: self };
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("command"))))))), &ctx)?.truthy() {
        let mut offered = self.to_json();
        if let crate::kernel::Json::Object(fields) = &mut offered {
            fields.sort_by(|a, b| a.0.cmp(&b.0));
        }
...
{
    let ctx = crate::kernel::EvalContext { args: &crate::kernel::NoFields, instance: self };
    if !crate::kernel::interpret(&Expr::Not(Box::new(Expr::Empty(Box::new(Expr::ToS(Box::new(Expr::Lookup("to_state"))))))), &ctx)?.truthy() {
        let mut offered = self.to_json();
        if let crate::kernel::Json::Object(fields) = &mut offered {
            fields.sort_by(|a, b| a.0.cmp(&b.0));
        }
        ...
        return Err(crate::kernel::Refusal::InvariantViolation(crate::kernel::RefusalSite::InvariantViolationValueObjectInvariant.render(&[
            ("name", "Transition"),
            ("description", "a to state is named"),
            ("offered", offered.as_str()),
        ])));
    }
}
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.command) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "Transition.command must match [^ \\t\\n\\r], got ", self.command))); }
        if !crate::kernel::pattern::matches("[^ \\t\\n\\r]", &self.to_state) { return Err(crate::kernel::Refusal::TypeMismatch(format!("{}{:?}", "Transition.to_state must match [^ \\t\\n\\r], got ", self.to_state))); }
        Ok(())
    }
}
...
pub fn dispatch_attribute(
    repo: &mut impl crate::kernel::Repository<Aggregate>, id: &str, args: AttributeArgs, mutations: &mut Vec<crate::kernel::MutationRecord>,
) -> crate::kernel::DispatchResult<Aggregate> {
        args.name.check_invariants()?;
...
if !unknown.is_empty() {
    return Err(crate::kernel::Refusal::UnknownArgument(format!(
        ...
        optional: match v.get("optional") { Some(x) => Some(ListFlag::from_json(x)?), None => None, },
        pattern: match v.get("pattern") { Some(x) => Some(LiteralText::from_json(x)?), None => None, },
        default: match v.get("default") { Some(x) => Some(LiteralText::from_json(x)?), None => None, },
        admits: match v.get("admits") { Some(x) => Some(LiteralText::from_json(x)?), None => None, },
        })
    }
}
...
pub fn dispatch_reference(
    repo: &mut impl crate::kernel::Repository<Aggregate>, id: &str, args: ReferenceArgs, mutations: &mut Vec<crate::kernel::MutationRecord>,
) -> crate::kernel::DispatchResult<Aggregate> {
        args.name.check_invariants()?;
        args.list.check_invariants()?;
        if let Some(v) = &args.optional { v.check_invariants()?; }
...
pub fn dispatch_holds(
    repo: &mut impl crate::kernel::Repository<Aggregate>, id: &str, args: HoldsArgs, mutations: &mut Vec<crate::kernel::MutationRecord>,
) -> crate::kernel::DispatchResult<Aggregate> {
        args.name.check_invariants()?;
        args.list.check_invariants()?;
        if let Some(v) = &args.optional { v.check_invariants()?; }
...
pub fn dispatch_transition(
    repo: &mut impl crate::kernel::Repository<Aggregate>, id: &str, args: TransitionArgs, mutations: &mut Vec<crate::kernel::MutationRecord>,
) -> crate::kernel::DispatchResult<Aggregate> {
...
if !unknown.is_empty() {
    return Err(crate::kernel::Refusal::UnknownArgument(format!(
        ...
        from_state: match v.get("from_state") { Some(x) => Some(FieldName::from_json(x)?), None => None, },
