...
| `bin/project_parser_table` | Generates rust/parser/src/keywords.rs FROM syntax.bluebook — the direct mechanism for "the parser's own grammar knowledge is DERIVED from... |
...
| `examples/banking/banking` | Banking's command line — GENERATED by bin/project_cli. Do not edit. A launcher, not a CLI: the verbs, their arguments and their refusals ... |
| `examples/pizzas/pizzas` | Pizzas's command line — GENERATED by bin/project_cli. Do not edit. A launcher, not a CLI: the verbs, their arguments and their refusals a... |
| `qa/quality_control` | QualityControl's command line — GENERATED by bin/project_cli. Do not edit. A launcher, not a CLI: the verbs, their arguments and their re... |
<!-- generated:end -->
