...
| `bin/banking` | Banking's command line — GENERATED by bin/project_cli. Do not edit. A launcher, not a CLI: the verbs, their arguments and their refusals ... |
...
| `bin/pizzas` | Pizzas's command line — GENERATED by bin/project_cli. Do not edit. A launcher, not a CLI: the verbs, their arguments and their refusals a... |
...
| `bin/quality_control` | QualityControl's command line — GENERATED by bin/project_cli. Do not edit. A launcher, not a CLI: the verbs, their arguments and their re... |
