...
- **Self-hosting** — Hecks generates itself from its own Bluebook chapters. All 17+ chapters (Bootstrap, Bluebook, Kernel, Runtime, Binding, CLI, Extensions, Targets, Workshop, Hecksagon, AI, Rails, Spec, Templating, Watchers, Persist, HecksAppeal, Examples) boot as running Hecks applications via `InMemoryLoader` + `Runtime`. 743 aggregates, 932 commands.
