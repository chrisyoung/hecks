# HecksCode
#
# HecksCode is a domain modeling language. This module is the
# language specification — it exposes the syntax, compiler,
# runtime, type system, module system, and IO model as
# inspectable components.
#
#   require "heckscode"
#
#   HecksCode.syntax        # => [:aggregate, :command, :attribute, ...]
#   HecksCode.compiler      # => { frontend: "DSL", ir: "DomainModel", ... }
#   HecksCode.self_hosting  # => { chapters: 15, aggregates: 670, commands: 836 }
#
require_relative "hecks"

module HecksCode
  HECKSTIES_ROOT = File.expand_path("../..", __FILE__)
  VERSION = "0.1.0"
