...
[0007](0007-rust-generates-code-not-ruby-source.md)/[0010](0010-ruby-is-the-reference-implementation.md)
...
- **The Projector framework (§30) becomes a de facto extension point for
  ...
  [0010](0010-ruby-is-the-reference-implementation.md) already establishes
