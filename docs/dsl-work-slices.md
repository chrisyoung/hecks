...
| **S16 — the self-use gate** | Model on `spec/fuzzing/meta_domain_coverage_spec.rb`. **Will fail the day it is written** — that is the point. Run last, now that S14/S15 have reduced what it reports. |
