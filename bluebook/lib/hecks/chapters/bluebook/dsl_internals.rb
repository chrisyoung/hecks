    ...
    module Bluebook
      module DslInternalsParagraph
        def self.define(b)
          ...
          b.aggregate "LibraryBuilder", "Builds Bluebook IR from chapter DSL definitions" do
            command("BuildBluebook") { attribute :name, String }
          end

          b.aggregate "BluebookBuilderMethods", "Top-level Hecks.domain method for defining domains" do
