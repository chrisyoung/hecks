...
module Hecks
  class Workbench
    ...
    #
    #   playground = Hecks::Workbench::Playground.new(domain)
    ...
    #
    # @return [String] e.g. '#<Hecks::Workbench::Playground "Pizzas" (3 events)>'
    def inspect
      "#<Hecks::Workbench::Playground \"#{@domain.name}\" (#{@events.size} events)>"
    end
