    ...
    class DomainApp < App
      ...
      def mount_routes(server)
        ...
        server.mount_proc "/_openapi" do |req, res|
          json_response(res, {"openapi"=>"3.0.0", "info"=>{"title"=>"PizzasDomain"}, "paths"=>{"/pizzas"=>{"get"=>{"summary"=>"List all pizzas"}}, "/pizzas/find"=>{"get"=>{"summary"=>"Find Pizza by ID"}}, "/pizzas/create_pizza"=>{"post"=>{"summary"=>"CreatePizza", "parameters"=>[{"name"=>"name", "type"=>"String"}, {"name"=>"description", "type"=>"String"}]}}, "/pizzas/add_topping"=>{"post"=>{"summary"=>"AddTopping", "parameters"=>[{"name"=>"pizza_id", "type"=>"Pizza"}, {"name"=>"name", "type"=>"String"}, {"name"=>"amount", "type"=>"Integer"}]}}, "/orders"=>{"get"=>{"summary"=>"List all orders"}}, "/orders/find"=>{"get"=>{"summary"=>"Find Order by ID"}}, "/orders/place_order"=>{"post"=>{"summary"=>"PlaceOrder", "parameters"=>[{"name"=>"customer_name", "type"=>"String"}, {"name"=>"pizza_id", "type"=>"String"}, {"name"=>"quantity", "type"=>"Integer"}]}}, "/orders/cancel_order"=>{"post"=>{"summary"=>"CancelOrder", "parameters"=>[{"name"=>"order_id", "type"=>"Order"}]}}}})
        end
